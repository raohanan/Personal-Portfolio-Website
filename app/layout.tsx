...
export const metadata: Metadata = {
  ...
  description:
    "Abdul Hanan is a full stack developer with expertise in Next.js and Tailwind CSS",
};
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        ></div>
        <div
          className="bg-[#dbd7fb] -z-10 absolute top[-6rem] right-[11rem] h-[31.25rem] w-[50rem]
